<?php
    ...
    $url = "$_SERVER[HTTP_HOST]" == "localhost:8000" ? '' : 'http://ixd.ucsd.edu/home/';
?>
<style type="text/css">
...
<div class="navbar navbar-default navbar-fixed-top" role="navigation">
    <div class="container">
        <div class="navbar-header">
            ...
            <?php
                $a_href = $url.'w18/index.php';
                echo '<a class="navbar-brand" href="'.$a_href.'">IxD</a>';
            ?>
        </div>
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
                <?php
                    ...
                    $a_start = '<a href="'.$url.'w18/index.php">';
                    echo $li_start;
                    echo $a_start;
                    echo 'Home</a></li>';
                ?>
                <?php
                    $li_start = '<li>';
                    $a_start = '<a href="'.$url.'w18/index.php#calendar">';
                    echo $li_start;
                    echo $a_start;
                    echo 'Calendar</a></li>';
                ?>
                <?php
                    ...
                    $a_start = '<a href="'.$url.'w18/studio.php">';
                    echo $li_start;
                    echo $a_start;
                    echo 'Studio</a></li>';
                ?>
                <?php
                    ...
                    $a_start = '<a href="'.$url.'w18/mobile_app_tips.php">';
                    echo $li_start;
                    echo $a_start;
                ...
                <?php
                    ...
                    echo '</ul></li>';
                ?>
                <li><a href="http://gradescope.com">Submit work</a></li>
            </ul>
            <ul class="nav navbar-nav navbar-right">
                <li><a href="http://piazza.com/ucsd/winter2018/cogs120cse170/home">Question? (Piazza)</a></li>
            </ul>
        </div>
        <!--/.nav-collapse -->
    </div>
