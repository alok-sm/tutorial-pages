  ...
  <body data-spy="scroll" data-target=".sidenav">
    ...
    <div class="container">
        <div class="row">
		    ...
		    opportunities. <br> All three are due on Sunday 3/18/2018 at
...
Since then, your prototype has probably made many twists, turns, and transformations, and is no longer recognizable as the idea that you started off with.
...
Pick five interesting projects that a juror is mostly like to ask you "How are you different from _____?"
...
In what situations would people use/do _____ instead of your application?"</p>
                ...
                <div id="video" class="sidenav-anchor">
                    ...
                    <p>Think of this video as a mixture of advertising and showing off all the hard work you have put into your application. <a href="https://www.youtube.com/watch?v=0vJdZ4McrNU" target="_blank">Here is a great example from IxD winter 2017</a>, and <a href="https://www.youtube.com/watch?v=QrkkrxbZ6TY" target="_blank">here is another great example also from IxD winter 2017</a>. Exercise your creativity as much as possible! Try to plan out your video before actually taking any footage. Storyboards are great tool to use here. This video will not be used as part of your final presentation slides, but should instead complement your poster session as well as serve as a way for you to remember your hard work in years to come. Upload these videos to YouTube.</p>
