...
<html>
  <head>
    ...
    <title>Lab&thinsp;9&thinsp;&middot;&thinsp;HCI Design</title>
  ...
  <body>
   ...
   <? include "../../nav.php" ?>
    ...
    <div id="instructions" class="alert alert-info">
      When done, submit <a href="https://tinyurl.com/w18ixd-lab9" class="alert-link">here</a>.
    </div>
  ...
  <div id="slide-1" class="row lab-slide">
    ...
    <img src="IntroHCI-w18-Lab9.001.png" class="img-responsive col-md-6"
      title="1" />
    <div class="col-md-5">
  ...
  <div id="slide-2" class="row lab-slide">
    ...
    <img src="IntroHCI-w18-Lab9.002.png" class="img-responsive col-md-6"
      title="2" />
    <div class="col-md-5">
  ...
  <div id="slide-3" class="row lab-slide">
    ...
    <img src="IntroHCI-w18-Lab9.003.png" class="img-responsive col-md-6"
      title="3" />
    <div class="col-md-5">
  ...
  <div id="slide-4" class="row lab-slide">
    ...
    <img src="IntroHCI-w18-Lab9.004.png" class="img-responsive col-md-6"
      title="4" />
    <div class="col-md-5">
  ...
  <div id="slide-5" class="row lab-slide">
    ...
    <img src="IntroHCI-w18-Lab9.005.png" class="img-responsive col-md-6"
      title="5" />
    <div class="col-md-5">
  ...
  <div id="slide-6" class="row lab-slide">
    ...
    <img src="IntroHCI-w18-Lab9.006.png" class="img-responsive col-md-6"
      title="6" />
    <div class="col-md-5">
  ...
  <div id="slide-7" class="row lab-slide">
    ...
    <img src="IntroHCI-w18-Lab9.007.png" class="img-responsive col-md-6"
      title="7" />
    <div class="col-md-5">
  ...
  <div id="slide-8" class="row lab-slide">
    ...
    <img src="IntroHCI-w18-Lab9.008.png" class="img-responsive col-md-6"
      title="8" />
    <div class="col-md-5">
  ...
  <div id="slide-9" class="row lab-slide">
    ...
    <img src="IntroHCI-w18-Lab9.009.png" class="img-responsive col-md-6"
      title="9" />
    <div class="col-md-5">
