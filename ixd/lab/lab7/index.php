...
<html>
  ...
  <div id="slide-1" class="row lab-slide">
    ...
    <img src="IntroHCI-w18-Lab7.001.png" class="img-responsive col-md-6"
      title="1" />
    <div class="col-md-5">
  ...
  <div id="slide-2" class="row lab-slide">
    ...
    <img src="IntroHCI-w18-Lab7.002.png" class="img-responsive col-md-6"
      title="2" />
    <div class="col-md-5">
  ...
  <div id="slide-3" class="row lab-slide">
    ...
    <img src="IntroHCI-w18-Lab7.003.png" class="img-responsive col-md-6"
      title="3" />
    <div class="col-md-5">
  ...
  <div id="slide-4" class="row lab-slide">
    ...
    <img src="IntroHCI-w18-Lab7.004.png" class="img-responsive col-md-6"
      title="4" />
    <div class="col-md-5">
  ...
  <div id="slide-5" class="row lab-slide">
    ...
    <img src="IntroHCI-w18-Lab7.005.png" class="img-responsive col-md-6"
      title="5" />
    <div class="col-md-5">
  ...
  <div id="slide-6" class="row lab-slide">
    ...
    <img src="IntroHCI-w18-Lab7.006.png" class="img-responsive col-md-6"
      title="6" />
    <div class="col-md-5">
  ...
  <div id="slide-7" class="row lab-slide">
    ...
    <img src="IntroHCI-w18-Lab7.007.png" class="img-responsive col-md-6"
      title="7" />
    <div class="col-md-5">
  ...
  <div id="slide-8" class="row lab-slide">
    ...
    <img src="IntroHCI-w18-Lab7.008.png" class="img-responsive col-md-6"
      title="8" />
    <div class="col-md-5">
  ...
  <div id="slide-9" class="row lab-slide">
    ...
    <img src="IntroHCI-w18-Lab7.009.png" class="img-responsive col-md-6"
      title="9" />
    <div class="col-md-5">
      
      <div class="code">
        <h4>Sample event calls</h4>
        <pre class='pre-scrollable'><code>gtag("send", "event", "friendsuggestion", "dismiss");
gtag("send", "event", "friendsuggestion", "accept");
gtag("send", "event", "humankind", "destroy");

gtag("send", "event", &lt;Category&gt;, &lt;Action&gt;);</code></pre>
      </div>
  ...
  <div id="slide-10" class="row lab-slide">
    ...
    <img src="IntroHCI-w18-Lab7.010.png" class="img-responsive col-md-6"
      title="10" />
    <div class="col-md-5">
  ...
  <div id="slide-11" class="row lab-slide">
    ...
    <img src="IntroHCI-w18-Lab7.011.png" class="img-responsive col-md-6"
      title="11" />
    <div class="col-md-5">
  ...
  <div id="slide-12" class="row lab-slide">
    ...
    <img src="IntroHCI-w18-Lab7.012.png" class="img-responsive col-md-6"
      title="12" />
    <div class="col-md-5">
  ...
  <div id="slide-13" class="row lab-slide">
    ...
    <img src="IntroHCI-w18-Lab7.013.png" class="img-responsive col-md-6"
      title="13" />
    <div class="col-md-5">
  ...
  <div id="slide-14" class="row lab-slide">
    ...
    <img src="IntroHCI-w18-Lab7.014.png" class="img-responsive col-md-6"
      title="14" />
    <div class="col-md-5">
  ...
  <div id="slide-15" class="row lab-slide">
    ...
    <img src="IntroHCI-w18-Lab7.015.png" class="img-responsive col-md-6"
      title="15" />
    <div class="col-md-5">
  ...
  <div id="slide-16" class="row lab-slide">
    ...
    <img src="IntroHCI-w18-Lab7.016.png" class="img-responsive col-md-6"
      title="16" />
    <div class="col-md-5">
      ...
      <div class="links">
        <h4>Links</h4>
        <ul>
          <li><a href='https://github.com/DesignAtLarge/lab7' target="_blank">https://github.com/DesignAtLarge/lab7</a></li>
        </ul>
      </div>
  ...
  <div id="slide-17" class="row lab-slide">
    ...
    <img src="IntroHCI-w18-Lab7.017.png" class="img-responsive col-md-6"
      title="17" />
    <div class="col-md-5">
  ...
  <div id="slide-18" class="row lab-slide">
    ...
    <img src="IntroHCI-w18-Lab7.018.png" class="img-responsive col-md-6"
      title="18" />
    <div class="col-md-5">
  ...
  <div id="slide-19" class="row lab-slide">
    ...
    <img src="IntroHCI-w18-Lab7.019.png" class="img-responsive col-md-6"
      title="19" />
    <div class="col-md-5">
  ...
  <div id="slide-20" class="row lab-slide">
    ...
    <img src="IntroHCI-w18-Lab7.020.png" class="img-responsive col-md-6"
      title="20" />
    <div class="col-md-5">
  ...
  <div id="slide-21" class="row lab-slide">
    ...
    <img src="IntroHCI-w18-Lab7.021.png" class="img-responsive col-md-6"
      title="21" />
    <div class="col-md-5">
  ...
  <div id="slide-22" class="row lab-slide">
    ...
    <img src="IntroHCI-w18-Lab7.022.png" class="img-responsive col-md-6"
      title="22" />
    <div class="col-md-5">
  ...
  <div id="slide-23" class="row lab-slide">
    ...
    <img src="IntroHCI-w18-Lab7.023.png" class="img-responsive col-md-6"
      title="23" />
    <div class="col-md-5">
      ...
      <div class="debug">
        ...
        <div class="well well-sm">
          ...
          <p>A zealous Adblock sometimes blocks messages to google analytics. Try disabling your adblock plugin for the duration of this lab if you have one.</p>
        </div>
      </div>
  ...
  <div id="slide-24" class="row lab-slide">
    ...
    <img src="IntroHCI-w18-Lab7.024.png" class="img-responsive col-md-6"
      title="24" />
    <div class="col-md-5">
  ...
  <div id="slide-25" class="row lab-slide">
    ...
    <img src="IntroHCI-w18-Lab7.025.png" class="img-responsive col-md-6"
      title="25" />
    <div class="col-md-5">
  ...
  <div id="slide-26" class="row lab-slide">
    ...
    <img src="IntroHCI-w18-Lab7.026.png" class="img-responsive col-md-6"
      title="26" />
    <div class="col-md-5">
  ...
  <div id="slide-27" class="row lab-slide">
    ...
    <img src="IntroHCI-w18-Lab7.027.png" class="img-responsive col-md-6"
      title="27" />
    <div class="col-md-5">
  ...
  <div id="slide-28" class="row lab-slide">
    ...
    <img src="IntroHCI-w18-Lab7.028.png" class="img-responsive col-md-6"
      title="28" />
    <div class="col-md-5">
      ...
      <div class="debug">
        <h4>Goal</h4>
        <div class="well well-sm">
          <span class="lead"><p>Run an A/B test on a minimalist vs. the old vertical layout</p></span>
          <p></p>
        </div>
      </div>
  ...
  <div id="slide-29" class="row lab-slide">
    ...
    <img src="IntroHCI-w18-Lab7.029.png" class="img-responsive col-md-6"
      title="29" />
    <div class="col-md-5">
  ...
  <div id="slide-30" class="row lab-slide">
    ...
    <img src="IntroHCI-w18-Lab7.030.png" class="img-responsive col-md-6"
      title="30" />
    <div class="col-md-5">
      ...
      <div class="debug">
        <h4>Troubleshoot</h4>
        <div class="well well-sm">
          <span class="lead"><p>It says "Cannot GET /viewAlt"</p></span>
  ...
  <div id="slide-31" class="row lab-slide">
    ...
    <img src="IntroHCI-w18-Lab7.031.png" class="img-responsive col-md-6"
      title="31" />
    <div class="col-md-5">
  ...
  <div id="slide-32" class="row lab-slide">
    ...
    <img src="IntroHCI-w18-Lab7.032.png" class="img-responsive col-md-6"
      title="32" />
    <div class="col-md-5">
  ...
  <div id="slide-33" class="row lab-slide">
    ...
    <img src="IntroHCI-w18-Lab7.033.png" class="img-responsive col-md-6"
      title="33" />
    <div class="col-md-5">
      ...
      <div class="debug">
        ...
        <div class="well well-sm">
          ...
          <p>Check back to Lab 3 slide about how listening to clicks</a></p>
        </div>
        <div class="well well-sm">
          <span class="lead"><p>How do I add the Google Analytics event?</p></span>
          <p>Remember back from <a href='#slide-9'>slide 9-Store any kind of event</a> on the form of <pre><code>gtag("send", "event", &lt;Category&gt;, &lt;Action&gt;);</code></pre> Substitute out <code>&lt;Category&gt;</code> for <code>'like'</code>, and <code>&lt;Action&gt;</code> for <code>'click'</code> and place it in the click event handler.</p>
        </div>
      </div>
  ...
  <div id="slide-34" class="row lab-slide">
    ...
    <img src="IntroHCI-w18-Lab7.034.png" class="img-responsive col-md-6"
      title="34" />
    <div class="col-md-5">
  ...
  <div id="slide-35" class="row lab-slide">
    ...
    <img src="IntroHCI-w18-Lab7.035.png" class="img-responsive col-md-6"
      title="35" />
    <div class="col-md-5">
  ...
  <div id="slide-36" class="row lab-slide">
    ...
    <img src="IntroHCI-w18-Lab7.036.png" class="img-responsive col-md-6"
      title="36" />
    <div class="col-md-5">
  ...
  <div id="slide-37" class="row lab-slide">
    ...
    <img src="IntroHCI-w18-Lab7.037.png" class="img-responsive col-md-6"
      title="37" />
    <div class="col-md-5">
  ...
  <div id="slide-38" class="row lab-slide">
    ...
    <img src="IntroHCI-w18-Lab7.038.png" class="img-responsive col-md-6"
      title="38" />
    <div class="col-md-5">
  ...
  <div id="slide-39" class="row lab-slide">
    ...
    <img src="IntroHCI-w18-Lab7.039.png" class="img-responsive col-md-6"
      title="39" />
    <div class="col-md-5">
  ...
  <div id="slide-40" class="row lab-slide">
    ...
    <img src="IntroHCI-w18-Lab7.040.png" class="img-responsive col-md-6"
      title="40" />
    <div class="col-md-5">
  ...
  <div id="slide-41" class="row lab-slide">
    ...
    <img src="IntroHCI-w18-Lab7.041.png" class="img-responsive col-md-6"
      title="41" />
    <div class="col-md-5">
  ...
  <div id="slide-42" class="row lab-slide">
    ...
    <img src="IntroHCI-w18-Lab7.042.png" class="img-responsive col-md-6"
      title="42" />
    <div class="col-md-5">
  ...
  <div id="slide-43" class="row lab-slide">
    ...
    <img src="IntroHCI-w18-Lab7.043.png" class="img-responsive col-md-6"
      title="43" />
    <div class="col-md-5">
  ...
  <div id="slide-44" class="row lab-slide">
    ...
    <img src="IntroHCI-w18-Lab7.044.png" class="img-responsive col-md-6"
      title="44" />
    <div class="col-md-5">
  ...
  <div id="slide-45" class="row lab-slide">
    ...
    <img src="IntroHCI-w18-Lab7.045.png" class="img-responsive col-md-6"
      title="45" />
    <div class="col-md-5">
  ...
  <div id="slide-46" class="row lab-slide">
    ...
    <img src="IntroHCI-w18-Lab7.046.png" class="img-responsive col-md-6"
      title="46" />
    <div class="col-md-5">
  ...
  <div id="slide-47" class="row lab-slide">
    ...
    <img src="IntroHCI-w18-Lab7.047.png" class="img-responsive col-md-6"
      title="47" />
    <div class="col-md-5">
  ...
  <div id="slide-48" class="row lab-slide">
    ...
    <img src="IntroHCI-w18-Lab7.048.png" class="img-responsive col-md-6"
      title="48" />
    <div class="col-md-5">
      ...
      <div class="links">
        <h4>Links</h4>
        <ul>
          <li><a href='http://tinyurl.com/w18hci-lab7' target="_blank">http://tinyurl.com/w18hci-lab7</a></li>
        </ul>
      </div>
  ...
  <div id="slide-49" class="row lab-slide">
    ...
    <img src="IntroHCI-w18-Lab7.049.png" class="img-responsive col-md-6"
      title="49" />
    <div class="col-md-5">
