...
<html>
  ...
  <body>
   ...
   <?php include "../../nav.php" ?>
    ...
    <div id="instructions" class="alert alert-info">
      When done, submit <a href="http://tinyurl.com/w17hci-lab8" class="alert-link">here</a>.
    </div>
  ...
  <div id="slide-1" class="row lab-slide">
    ...
    <img src="introhci-w17-lab8.001.png" class="img-responsive col-md-6"
      title="1" />
    <div class="col-md-5">
  ...
  <div id="slide-2" class="row lab-slide">
    ...
    <img src="introhci-w17-lab8.002.png" class="img-responsive col-md-6"
      title="2" />
    <div class="col-md-5">
  ...
  <div id="slide-3" class="row lab-slide">
    ...
    <img src="introhci-w17-lab8.003.png" class="img-responsive col-md-6"
      title="3" />
    <div class="col-md-5">
  ...
  <div id="slide-4" class="row lab-slide">
    ...
    <img src="introhci-w17-lab8.004.png" class="img-responsive col-md-6"
      title="4" />
    <div class="col-md-5">
  ...
  <div id="slide-5" class="row lab-slide">
    ...
    <img src="introhci-w17-lab8.005.png" class="img-responsive col-md-6"
      title="5" />
    <div class="col-md-5">
  ...
  <div id="slide-6" class="row lab-slide">
    ...
    <img src="introhci-w17-lab8.006.png" class="img-responsive col-md-6"
      title="6" />
    <div class="col-md-5">
  ...
  <div id="slide-7" class="row lab-slide">
    ...
    <img src="introhci-w17-lab8.007.png" class="img-responsive col-md-6"
      title="7" />
    <div class="col-md-5">
  ...
  <div id="slide-8" class="row lab-slide">
    ...
    <img src="introhci-w17-lab8.008.png" class="img-responsive col-md-6"
      title="8" />
    <div class="col-md-5">
  ...
  <div id="slide-9" class="row lab-slide">
    ...
    <img src="introhci-w17-lab8.009.png" class="img-responsive col-md-6"
      title="9" />
    <div class="col-md-5">
  ...
  <div id="slide-10" class="row lab-slide">
    ...
    <img src="introhci-w17-lab8.010.png" class="img-responsive col-md-6"
      title="10" />
    <div class="col-md-5">
      ...
      <div class="links">
        <h4>Links</h4>
        <ul>
          <li><a href='https://github.com/DesignAtLarge/lab8/fork' target="_blank">https://github.com/DesignAtLarge/lab8/fork</a></li>
        </ul>
      </div>
  ...
  <div id="slide-11" class="row lab-slide">
    ...
    <img src="introhci-w17-lab8.011.png" class="img-responsive col-md-6"
      title="11" />
    <div class="col-md-5">
  ...
  <div id="slide-12" class="row lab-slide">
    ...
    <img src="introhci-w17-lab8.012.png" class="img-responsive col-md-6"
      title="12" />
    <div class="col-md-5">
  ...
  <div id="slide-13" class="row lab-slide">
    ...
    <img src="introhci-w17-lab8.013.png" class="img-responsive col-md-6"
      title="13" />
    <div class="col-md-5">
  ...
  <div id="slide-14" class="row lab-slide">
    ...
    <img src="introhci-w17-lab8.014.png" class="img-responsive col-md-6"
      title="14" />
    <div class="col-md-5">
  ...
  <div id="slide-15" class="row lab-slide">
    ...
    <img src="introhci-w17-lab8.015.png" class="img-responsive col-md-6"
      title="15" />
    <div class="col-md-5">
  ...
  <div id="slide-16" class="row lab-slide">
    ...
    <img src="introhci-w17-lab8.016.png" class="img-responsive col-md-6"
      title="16" />
    <div class="col-md-5">
  ...
  <div id="slide-17" class="row lab-slide">
    ...
    <img src="introhci-w17-lab8.017.png" class="img-responsive col-md-6"
      title="17" />
    <div class="col-md-5">
  ...
  <div id="slide-18" class="row lab-slide">
    ...
    <img src="introhci-w17-lab8.018.png" class="img-responsive col-md-6"
      title="18" />
    <div class="col-md-5">
...
&lt;/fb:login-button&gt;</code></pre>
  ...
  <div id="slide-19" class="row lab-slide">
    ...
    <img src="introhci-w17-lab8.019.png" class="img-responsive col-md-6"
      title="19" />
    <div class="col-md-5">
...
function statusChangeCallback(response) {
  ...
  <div id="slide-20" class="row lab-slide">
    ...
    <img src="introhci-w17-lab8.020.png" class="img-responsive col-md-6"
      title="20" />
    <div class="col-md-5">
  ...
  <div id="slide-21" class="row lab-slide">
    ...
    <img src="introhci-w17-lab8.021.png" class="img-responsive col-md-6"
      title="21" />
    <div class="col-md-5">
  ...
  <div id="slide-22" class="row lab-slide">
    ...
    <img src="introhci-w17-lab8.022.png" class="img-responsive col-md-6"
      title="22" />
    <div class="col-md-5">
  ...
  <div id="slide-23" class="row lab-slide">
    ...
    <img src="introhci-w17-lab8.023.png" class="img-responsive col-md-6"
      title="23" />
    <div class="col-md-5">
      
      <div class="debug">
        <h4>Forgot your API key?</h4>
        <div class="well well-sm">
          <span class="lead"><p>You can find your API key again by clicking 'Get a Key' again (same button as before) and selecting your app name from the dropdown, and clicking 'Enable Api'</p></span>
          <p></p>
        </div>
      </div>
  ...
  <div id="slide-24" class="row lab-slide">
    ...
    <img src="introhci-w17-lab8.024.png" class="img-responsive col-md-6"
      title="24" />
    <div class="col-md-5">
  ...
  <div id="slide-25" class="row lab-slide">
    ...
    <img src="introhci-w17-lab8.025.png" class="img-responsive col-md-6"
      title="25" />
    <div class="col-md-5">
      
      <div class="code">
        <h4>Terminal</h4>
        <pre class='pre-scrollable'><code>&lt;script src="/js/googleMaps.js"&gt;&lt;/script&gt;
{{&gt; googleMaps}}
</code></pre>
      </div>
  ...
  <div id="slide-26" class="row lab-slide">
    ...
    <img src="introhci-w17-lab8.026.png" class="img-responsive col-md-6"
      title="26" />
    <div class="col-md-5">
  ...
  <div id="slide-27" class="row lab-slide">
    ...
    <img src="introhci-w17-lab8.027.png" class="img-responsive col-md-6"
      title="27" />
    <div class="col-md-5">
  ...
  <div id="slide-28" class="row lab-slide">
    ...
    <img src="introhci-w17-lab8.028.png" class="img-responsive col-md-6"
      title="28" />
    <div class="col-md-5">
  ...
  <div id="slide-29" class="row lab-slide">
    ...
    <img src="introhci-w17-lab8.029.png" class="img-responsive col-md-6"
      title="29" />
    <div class="col-md-5">
  ...
  <div id="slide-30" class="row lab-slide">
    ...
    <img src="introhci-w17-lab8.030.png" class="img-responsive col-md-6"
      title="30" />
    <div class="col-md-5">
      
      <div class="code">
        <h4>index.handlebars</h4>
        <pre class='pre-scrollable'><code>&lt;script src="/js/camera.js"&gt;&lt;/script&gt;</code></pre>
      </div>
      
      <div class="debug">
        <h4>I got an error in my browser console</h4>
        <div class="well well-sm">
          <span class="lead"><p>Make sure to uncomment the camera code in your index.handlebars</p></span>
          <p></p>
        </div>
      </div>
  ...
  <div id="slide-31" class="row lab-slide">
    ...
    <img src="introhci-w17-lab8.031.png" class="img-responsive col-md-6"
      title="31" />
    <div class="col-md-5">
...
git commit -m "Third party APIs"</code></pre>
  ...
  <div id="slide-32" class="row lab-slide">
    ...
    <img src="introhci-w17-lab8.032.png" class="img-responsive col-md-6"
      title="32" />
    <div class="col-md-5">
      ...
      <div class="links">
        <h4>Links</h4>
        <ul>
          <li><a target='_blank' href='#slide-15'>Slide 15-Set Facebook API URL</a></li>
        </ul>
      </div>
  ...
  <div id="slide-33" class="row lab-slide">
    ...
    <img src="introhci-w17-lab8.033.png" class="img-responsive col-md-6"
      title="33" />
    <div class="col-md-5">
  ...
  <div id="slide-34" class="row lab-slide">
    ...
    <img src="introhci-w17-lab8.034.png" class="img-responsive col-md-6"
      title="34" />
    <div class="col-md-5">
  ...
  <div id="slide-35" class="row lab-slide">
    ...
    <img src="introhci-w17-lab8.035.png" class="img-responsive col-md-6"
      title="35" />
    <div class="col-md-5">
  ...
  <div id="slide-36" class="row lab-slide">
    ...
    <img src="introhci-w17-lab8.036.png" class="img-responsive col-md-6"
      title="36" />
    <div class="col-md-5">
      
      <div class="code">
        <h4>routes/tasks.js</h4>
        <pre class='pre-scrollable'><code>exports.addTask = function(req, res){
var taskName = req.body.taskName;
  ...
  res.send(taskName);
      ...
      <div class="code">
        <h4>Add to app.js</h4>
        <pre class='pre-scrollable'><code>app.post('/addTask', tasks.addTask);</code></pre>
      </div>
  ...
  <div id="slide-37" class="row lab-slide">
    ...
    <img src="introhci-w17-lab8.037.png" class="img-responsive col-md-6"
      title="37" />
    <div class="col-md-5">
      
      <div class="code">
        <h4>views/tasks.handlebars</h4>
        <pre class='pre-scrollable'><code>&lt;form id='taskForm' action='/addTask' method='post'&gt;
...
&lt;/form&gt;</code></pre>
  ...
  <div id="slide-38" class="row lab-slide">
    ...
    <img src="introhci-w17-lab8.038.png" class="img-responsive col-md-6"
      title="38" />
    <div class="col-md-5">
      
      <div class="code">
        <h4>public/js/tasks.js</h4>
        <pre class='pre-scrollable'><code>// Your code goes here
...
function postCallback(res) {
 ...
 $('#addTask').val(''); // Clear form
  ...
  <div id="slide-39" class="row lab-slide">
    ...
    <img src="introhci-w17-lab8.039.png" class="img-responsive col-md-6"
      title="39" />
    <div class="col-md-5">
  ...
  <div id="slide-40" class="row lab-slide">
    ...
    <img src="introhci-w17-lab8.040.png" class="img-responsive col-md-6"
      title="40" />
    <div class="col-md-5">
  ...
  <div id="slide-41" class="row lab-slide">
    ...
    <img src="introhci-w17-lab8.041.png" class="img-responsive col-md-6"
      title="41" />
    <div class="col-md-5">
  ...
  <div id="slide-42" class="row lab-slide">
    ...
    <img src="introhci-w17-lab8.042.png" class="img-responsive col-md-6"
      title="42" />
    <div class="col-md-5">
      
      <div class="code">
        <h4>Code</h4>
        <pre class='pre-scrollable'><code>&lt;ul class='nav nav-pills nav-justified'&gt
...
&lt;/ul&gt;</code></pre>
  ...
  <div id="slide-43" class="row lab-slide">
    ...
    <img src="introhci-w17-lab8.043.png" class="img-responsive col-md-6"
      title="43" />
    <div class="col-md-5">
  ...
  <div id="slide-44" class="row lab-slide">
    ...
    <img src="introhci-w17-lab8.044.png" class="img-responsive col-md-6"
      title="44" />
    <div class="col-md-5">
  ...
  <div id="slide-45" class="row lab-slide">
    ...
    <img src="introhci-w17-lab8.045.png" class="img-responsive col-md-6"
      title="45" />
    <div class="col-md-5">
  ...
  <div id="slide-46" class="row lab-slide">
    ...
    <img src="introhci-w17-lab8.046.png" class="img-responsive col-md-6"
      title="46" />
    <div class="col-md-5">
      ...
      <div class="code">
        ...
        <pre class='pre-scrollable'><code>git status
git add ... 
git commit -m "added partials"</code></pre>
      </div>
  ...
  <div id="slide-47" class="row lab-slide">
    ...
    <img src="introhci-w17-lab8.047.png" class="img-responsive col-md-6"
      title="47" />
    <div class="col-md-5">
      ...
      <div class="debug">
        <h4>Stretch Goals</h4>
        <div class="well well-sm">
          <span class="lead"><p>Four stretch goals this time. Pick at least one!</p></span>
          <p><ol><li>Incorporate your fb friends list into the website.</li><li>Add a new marker to Maps on click</li><li>When you take a photo with the camera, have it update your profile photo on the website.</li><li>Add delete task functionality!</li></ol></p>
        </div>
      </div>
